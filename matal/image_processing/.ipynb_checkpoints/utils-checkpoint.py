...
def find_correction_mat(src_img, return_counters=False, sort_by_area=True):
    ...
    for (i, c) in enumerate(cnts):
        ...
        dx = 0 if sx < iw / 2 else output_size
        dy = 0 if sy < ih / 2 else output_size
