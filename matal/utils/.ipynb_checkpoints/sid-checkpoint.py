...
BATCH_USAGE_LUT = {
    'A': 'active_learning',  # Active Learning Round
    'B': 'reserved_2',
    'C': 'reserved_3',
    ...
    'F': 'design_boundary',
    'G': 'design_boundary_2',
    'H': 'active_learning_trial', # Active Learning Trial
    'J': 'active_learning_trial_1', # Active Learning Trial
    'L': 'link_only',
    'M': 'miscellaneous',
